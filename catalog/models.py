...
class Book(models.Model):
    ...
    genre = models.ManyToManyField(Genre, help_text='Select a genre for tis book')
...
class BookInstance(models.Model):
    ...
    class Meta:
        ordering = ["due_back"]
        permissions = (("can_mark_returned", "Set book as returned"), ("can_see_borrowed_books", "See All Borrowed Books"),)
